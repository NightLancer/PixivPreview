...
■ Click left mouse button on image preview to open original art in new tab, or middle mouse button to open art illustration page. <strong>Also install <a href=https://github.com/NightLancer/PixivPreview/raw/master/NewTabImageOpen.user.js>"NewTabImageOpen.user.js"</a> for proper new tab image originals opening!<br></strong>
